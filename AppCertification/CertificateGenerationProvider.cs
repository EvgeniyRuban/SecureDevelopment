...
public sealed class CertificateGenerationProvider
{
    public void GenerateRootCertificate(CertificateConfiguration settings)
    {
        ...
        RsaKeyGenerationParameters prms = new RsaKeyGenerationParameters(
        ...
        certGen.SetNotBefore(dateTimeNow);
        certGen.SetNotAfter(dateTimeNow + settings.CertDuration);
